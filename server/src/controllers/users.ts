...
export const signin = async(req: Request,res: Response) => {
    ...
    try {
        ...
        const token = jwt.sign({email: existinguser.email, id: existinguser._id}, process.env.SECRET_KEY || 'test' , {expiresIn: '1d'});
...
export const signup = async(req: Request,res: Response) => {
    ...
    try{
        ...
        const token = jwt.sign({email: result.email, id: result._id}, process.env.SECRET_KEY || 'test', {expiresIn: '1d'});
